...
<body>
	...
	<table border="1" style="width: 100%;">
		...
		<tr>
			...
			<td><spring:url value="/blog/saveUpdated" var="updateBlog"></spring:url>
				<form action="${updateBlog}">
					<table>
						<caption>Update Blog Details Here</caption>
						<tbody>
							<tr>
								<td>Blog Id:</td>
								<td><input type="text" name="blogId"
									value="${requestScope.myBlog.id}" /></td>
							</tr>
							<tr>
								<td>Title:</td>
								<td><input type="text" name="title"
									placeholder="Enter Title" value="${requestScope.myBlog.title}" /></td>
							</tr>
							<tr>
								<td>Contents:</td>
								<td><input type="text" name="contents"
									placeholder="Enter contents here"
									value="${requestScope.myBlog.contents}" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="button" value="Cancel"
									onclick="window.location.href='http://localhost:8080/bms/blog/';"></td>
							</tr>
						</tbody>
					</table>
				</form></td>
